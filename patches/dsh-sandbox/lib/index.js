...
*/
const WIDER_MODES = {
	"read-only": ["workspace-write", "net-access", "danger-full-access"],
	"workspace-write": ["net-access", "danger-full-access"],
	"net-access": ["danger-full-access"]
};
/**
...
*/
const ESCALATION_TARGETS = ["workspace-write", "net-access", "danger-full-access"];
/**
...
function writableRoots(policy) {
	if (policy.mode !== "workspace-write" && policy.mode !== "net-access") return [];
	return [...new Set([
